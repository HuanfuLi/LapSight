...
data class TimingRunSnapshot(
    ...
    val currentSectorNumber: Int?,
    val sectorCount: Int,
    val latestSectorName: String?,
    val latestSectorSplitMillis: Long?,
    val source: SourceMetadata?,
    ...
    companion object {
        ...
        fun inactive(): TimingRunSnapshot = TimingRunSnapshot(
            ...
            altitudeMeters = null,
            sampleRateHz = null,
            currentSectorNumber = null,
            sectorCount = 0,
            latestSectorName = null,
            latestSectorSplitMillis = null,
            source = null,
